...
namespace cpkm::config {
namespace builder {
struct builder_config {
  std::string type;
  std::string version;
};

struct cmake : builder_config {
...
struct targetConfig {
  ...
  // std::list<std::string> linkLibs;
  // std::list<std::string> linkLibPaths;
  // std::list<std::string> linkFlags;
};
}
...
inline void to_json(nlohmann::json& j, const package_config<builder::cmake>& p) {
  // prepare builder
...
inline void from_json(const nlohmann::json& j, package_config<builder::cmake>& p) {
...
template struct cpkm::config::package_config<cpkm::config::builder::cmake>;
